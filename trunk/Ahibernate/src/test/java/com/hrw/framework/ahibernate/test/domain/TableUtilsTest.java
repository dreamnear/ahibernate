...
public class TableUtilsTest {
    ...
    public void testBuildCreateTableStatements() {
        String result = TableUtils.buildCreateTableStatement(new TableInfo(Book.class), false);
        Assert.assertEquals("CREATE TABLE book (id INTEGER PRIMARY KEY, book_name TEXT)", result);
    ...
    public void testbuildInsertTableStatements() {
        ...
        Assert.assertEquals("INSERT INTO book (id, book_name) values (?, ?)", result);
    }
